...
class MEXC:
    def __init__(self):
        ...
        self.url_keys = {
            self.web_data["MEXC"]["all_tickers"]: "all_tickers",
            self.web_data["MEXC"]["all_name_tickers"]: "all_name_tickers",
            self.web_data["MEXC"]["commission"]: "commission"
        }
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = f"MEXC\\response_{key}.json"
