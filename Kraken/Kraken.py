...
class Kraken:
    def __init__(self):
        ...
        self.base_url = self.web_data["Kraken"]["url"]

        # Создание списка URL и их соответствующих ключей
        self.url_keys = {
            self.web_data["Kraken"]["all_tickers"]: "all_tickers",
            self.web_data["Kraken"]["commission"]: "commission"
        }
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = f"Kraken\\response_{key}.json"
