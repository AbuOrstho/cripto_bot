...
class Huobi:
    def __init__(self):
        ...
        self.url_keys = {
            self.web_data["Huobi"]["all_tickers"]: "all_tickers",
            self.web_data["Huobi"]["all_name_tickers"]: "all_name_tickers",
            self.web_data["Huobi"]["commission"]: "commission"
        }
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = f"Huobi\\response_{key}.json"
