...
class Coinex:
    def __init__(self):
        ...
        self.url_keys = {
            self.web_data["Coinex"]["all_tickers"]: "all_tickers",
            self.web_data["Coinex"]["all_name_tickers"]: "all_name_tickers",
            self.web_data["Coinex"]["commission"]: "commission"
        }
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = f"Coinex\\response_{key}.json"
