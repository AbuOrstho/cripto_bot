...
class KuCoin:
    def __init__(self):
        ...
        self.base_url = self.web_data["KuCoin"]["url"]

        # Создание списка URL и их соответствующих ключей
        self.url_keys = {
            self.web_data["KuCoin"]["all_tickers"]: "all_tickers",
            self.web_data["KuCoin"]["commission"]: "commission"
        }
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = f"KuCoin\\response_{key}.json"
