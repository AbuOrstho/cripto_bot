...
class Poloniex:
    def __init__(self):
        ...
        self.base_url = self.web_data["Poloniex"]["url"]

        # Создание списка URL и их соответствующих ключей
        self.url_keys = {
            self.web_data["Poloniex"]["all_tickers"]: "all_tickers",
            self.web_data["Poloniex"]["commission"]: "commission"
        }
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = f"Poloniex\\response_{key}.json"
